...
import "index.scss";
import DayListItem from "/Users/macbar/Documents/LHL/second_try/w6/scheduler/src/components/DayListItem.js";
...
storiesOf("Appointment", "Header", module)
  ...
  .add("Create", () =>//Form on create
  <Form
  interviewers={interviewers}
  onSave={action('onSave')}
  onCancel={action('onCancel')}
  />)
  .add("Edit", () =>//Form on Edit
  <Form
  student="Habib"
  interviewer={2}
  interviewers={interviewers}
